                ...
                <div class="col-12">
                    ...
                    <form action="{{ route('blogs.update', ['blog' => $blog]) }}" class="form-contact contact_form"
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="5" class="w-100 border" name="description" placeholder="Enter Your Description">
                                {{ $blog->description }}
                            </textarea>
                        ...
                        <div class="form-group text-center text-md-right mt-3">
                            ...
                            <button type="submit" class="button button--active button-contactForm">Ubdate Blog</button>
